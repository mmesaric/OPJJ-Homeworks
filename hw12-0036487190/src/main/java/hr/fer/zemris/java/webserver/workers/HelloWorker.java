...
/**
 * This class represents the implementation of a hello worker given by professor
 * Marko čupić. If called with parameters, checks the length of them and prints
 * it out. If no argument was passed, notifies the user of that.
 * 
